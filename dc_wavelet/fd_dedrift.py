...
### block is [-5 30] 50hz sampling rate ###
s_count=0
...
plt.subplot(511)
figure_title = "Original Data"
plt.title(figure_title, y=0.8)
plt.plot(dc_channel_padded)

plt.subplot(512)
figure_title = "First Order Difference"
plt.title(figure_title, y=0.8)
plt.plot(dc_channel_fd_padded)

plt.subplot(513)
figure_title = "Remove First order Difference"
plt.title(figure_title, y=0.8)
plt.plot(dc_channel_drift)

plt.subplot(514)
figure_title = "after wavelet thresholding"
plt.title(figure_title, y=0.8)
plt.plot(drift_test)

plt.subplot(515)
figure_title = "de_drifted data"
plt.title(figure_title, y=0.8)
